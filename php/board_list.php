...
<section>
    <div id="board_box">
        ...
        <span class="sort"><a href="board_list.php?mode=latest">최신순 |</a></span>
        <span><a href="board_list.php?mode=oldest"> 오래된순 |</a></span>
        <span><a href="board_list.php?mode=popular"> 조회순 |</a></span>
        <span><a href="board_list.php?mode=recommend">추천순</a></span>
        <ul id="board_list">
            <li>
            ...
            $sql = "select * from board order by $order";
